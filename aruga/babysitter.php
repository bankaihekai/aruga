                  ...
                  if (mysqli_num_rows($result) > 0) {
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                      ...
                      if (strtolower($row['status']) == "active") {
                        ...
                        echo "<a class='confirmation action-head btn btn-sm btn-success text-white'href='update.php?user_id=" . $row['user_id'] . "&page=babysitter'>Unband</a>";
                      } else {
                                ...
                                <div class="fv-main">
                                  <div class="fv1">
                                    <div>
                                      ...
                                      <input type="text" value="<?php echo $row['telNo1'] ?>" readonly><br>
