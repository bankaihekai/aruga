                  ...
                  if (mysqli_num_rows($result) > 0) {
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                      ...
                      if (strtolower($row['status']) == "active") {
                        ...
                        echo "<a class='confirmation action-head btn btn-sm btn-success text-white'href='update.php?user_id=" . $row['user_id'] . "&page=parent'>Unband</a>";
                            ...
                            <div class="modal-body" id="modalBody">
                              <form method="post" class="form-view ">
                                <div class="w-100 mb-3 d-flex justify-content-center">
                                  <div>
                                    <?php echo '<img id="profile_img" src="data:image;base64,' . base64_encode($row["profile_img"]) . '" width="100">' ?>
                                  </div>
                                </div>
                                <div class="fv-main">
                                  <div class="fv1">
                                    <div>
                                      ...
                                      <label for="telNo1" class="modalLabel">TelNo.</label>
                                      <input type="text" value="<?php echo $row['telNo1'] ?>"><br>
                                ...
                                <div class="d-flex justify-content-end w-100">
                                  <?php
                                  if (!strcasecmp(strtolower($row['status']), "Expired Subscription")) {
